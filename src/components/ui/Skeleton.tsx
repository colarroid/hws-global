 ...
 * one that feels like a fault. On a slow connection, which is a good share of
 * this audience, that difference is most of the experience.
 *
...
/** One card in a list of results, organisations or saved things. */
