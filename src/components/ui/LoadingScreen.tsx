...
/**
 * The wait, as the results screen has always done it.
 *
 * That screen names the wait in words and blocks out what is coming in the
 * site's own colours, and it is the right answer everywhere rather than only
 * there. A spinner could mean anything, and on a patchy connection "anything"
 * reads as broken. A sentence saying what is being fetched, and roughly how
 * long, tells somebody whether to wait or to give up, which is the only
